...
def colorMap(val, colormap = "default"):
	...
	elif colormap == "PiYG_3":
		baseColor = np.array([[233,163,201],
                            [247,247,247],
                            [161,215,106]])
	elif colormap == "RdPu_3":
		baseColor = np.array([[253, 224, 221], [0, 159, 181], [197, 27, 138]])
	elif colormap == "RdPu_2":
		baseColor = np.array([[253, 224, 221],[0, 159, 181] ,[0, 159, 181]])
	elif colormap == "Paired_12":
		baseColor = np.array([[166, 206, 227],
							[31, 120, 180],
							[178, 223, 138],
							[51, 160, 44],
							[251, 154, 153],
