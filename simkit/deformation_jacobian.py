...
Volumetric (P1 simplex) elements, where the deformation gradient is square.
Membrane elements -- triangles embedded in 3D, whose ``F`` is ``3x2`` -- have
their own module: :mod:`simkit.membrane_deformation_jacobian`.
"""
