...
#     vol = vol.reshape(-1, 1)
#     lam = lam.reshape(-1, 1)
#     arap_e = 2 * np.sum(arap_energy_element_F(F, mu) * vol)
...
#     arap_g = 2 * arap_gradient_element_F(F, mu) * vol.reshape(-1, 1, 1)
...
#     H = H_vol * vol.reshape(-1, 1, 1) + 2 * arap_hessian_element_F(F, mu) * vol.reshape(-1, 1, 1)
